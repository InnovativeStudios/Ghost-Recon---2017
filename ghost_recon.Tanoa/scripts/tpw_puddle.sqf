...
//VARIABLES
tpw_puddle_version = "1.00"; // Version string
...
tpw_puddle_ripple =  _this select  6; // 1 = use rippling water shader for puddles - will give visual anomolies
...
tpw_puddle_fnc_spawn =
	...
	// Small puddles
	_type = ["PUDDLE_S","PUDDLERIPPLE_S"] select tpw_puddle_ripple;
	...
	// Larger puddles
	_type = ["PUDDLE_M","PUDDLERIPPLE_M"] select tpw_puddle_ripple;
	for "_i" from 1 to tpw_puddle_max do
		{
		_puddle = _type createvehicle [0,0,10000]; 
		_puddle setdir random 360;
