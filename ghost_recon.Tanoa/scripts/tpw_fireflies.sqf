/*
TPW FIREFLIES - Animated glowing fireflies on warm evenings
Version: 1.00
Author: tpw
...
// VARIABLES
tpw_firefly_version = "1.00"; // Version string
...
// CONDITIONS FOR SPAWNING FIREFLIES
...
// RUN IT 
tpw_firefly_dusktime = ([] call BIS_fnc_sunriseSunsetTime) select 1;
